...
public class CreateWindow extends Window {
    ...
    private void goToMainWindow() {
        try {
            ServerResponse<User> response = Client.client.createNewUser(jtfUsername.getText(), jtfPassword.getText());
            ...
            else if (response.status == Client.client.STATUS_CODE_USER_ALREADY_EXISTS) {
                JOptionPane.showMessageDialog(this, "User already exists.", "ATTENTION", JOptionPane.WARNING_MESSAGE);
            }
            else {
